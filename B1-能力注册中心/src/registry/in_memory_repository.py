...
class InMemoryDefinitionRepository(DefinitionRepository):
    ...
    async def get_by_nkv(self, namespace: str, key: str, version: str) -> Optional[dict]:
        ...
        for obj in self._objects.values():
            ...
            if (meta.get('namespace') == namespace and
                meta.get('key') == key and
    ...
    async def list_by_filter(self, filter: DefinitionFilter, 
    ...
    async def save_dependency(self, source_id: str, source_version: str,
        ...
        for dep in self._dependencies:
            if (dep['source_id'] == source_id and
                dep['source_version'] == source_version and
                dep['target_id'] == target_id and
                dep['target_version'] == target_version and
    ...
    async def get_dependencies(self, id: str, version: str) -> list[dict]:
        """获取依赖关系"""
        return [
            copy.deepcopy(dep) for dep in self._dependencies
