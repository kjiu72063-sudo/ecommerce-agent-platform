...
Key = Annotated[str, Field(pattern=r"^[a-z0-9][a-z0-9-]{1,126}[a-z0-9]$", min_length=3, max_length=128)]
Namespace = Annotated[str, Field(pattern=r"^[a-z0-9][a-z0-9._-]{0,126}[a-z0-9]$", min_length=2, max_length=128)]
...
class DefinitionMetadata(StrictModel):
    ...
    scope: Scope
    labels: dict[Annotated[str, Field(pattern=r"^[a-z0-9][a-z0-9._/-]{0,62}$")], Annotated[str, Field(max_length=256)]] = Field(default_factory=dict)
    annotations: dict[Annotated[str, Field(max_length=128)], Annotated[str, Field(max_length=2048)]] = Field(default_factory=dict)
