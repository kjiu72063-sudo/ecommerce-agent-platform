...
async def test_factory_uses_b1_definition_source_for_runner():
    registry = Registry([
        ...
        definition("PromptPackage", "prm_01111111-1111-7111-8111-111111111111", "presale-prompt", "2.0.0"),
        definition("ContextPolicy", "cpo_01111111-1111-7111-8111-111111111111", "presale-context", "3.0.0"),
    ])
    factory = PresaleRuntimeFactory(
        ...
        sources=[KnowledgeSource(
            source_id="catalog-001", version="2026.09.01", tenant_id="tenant-demo",
            product_id="product-001", status="published", fields={"spec": {"season": "适合夏季使用"}}
        )],
    )
